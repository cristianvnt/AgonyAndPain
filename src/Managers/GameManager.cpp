...
{
	_gameSettings.SetTitle(_configManager.GetValue<std::string>(Settings::SECTION_GAME, Settings::TITLE, "AGONY and PAIN"))
		.SetWidth(_configManager.GetValue<int>(Settings::SECTION_GAME, Settings::WIDTH, 800))
...
GameManagerSettings& GameManagerSettings::SetTitle(std::string title)
{
	_title = title;
	return *this;
}
